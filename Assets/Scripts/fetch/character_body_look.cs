...
public class character_body_look : MonoBehaviour 
{
	...
	void Update()
	{
		...
		transform.rotation = Quaternion.Slerp(transform.rotation, new Quaternion(0, _lookRotation.y, 0, _lookRotation.w), Time.deltaTime * lookSpeed);
	}
